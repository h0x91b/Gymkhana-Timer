...
// WebGL variant of the entry point. Identical to app.js except for
// this single import: the detector implementation is GPU-based and
// reads back a single pixel per frame instead of dragging the whole
// ROI through getImageData. See webgl-detector.js for the pipeline.
import { Detector } from './webgl-detector.js';
